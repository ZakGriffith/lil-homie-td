...
export class Enemy extends Phaser.Physics.Arcade.Sprite {
    constructor(scene, x, y, kind) {
        ...
        this.attackCd = 0;
        this.dying = false;
        this.flying = false; // flying enemies ignore terrain and go straight to player
        this.noCoinDrop = false; // boss-spawned enemies don't drop coins
        this.targetRef = null; // current target object (player, tower, wall)
        this.facing = 'r'; // directional facing for bear
        this.kind = kind;
        this.hp = data.hp;
        this.maxHp = data.hp;
